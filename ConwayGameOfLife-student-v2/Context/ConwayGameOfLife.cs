...
{
    public class ConwayGameOfLife // : ILifeBehaviour
    {
        ...
        public void Evolve()
        {
            ...
            for (int r = 0; r < HEIGHT; r++)
            {
                ...
                for (int c = 0; c < WIDTH; c++)
                {
                    ...
                    // cell should live?
                    this.space[r, c] = behaviour.CellShouldLive(livingCell, neighBourCount); // Variabele 'behaviour' is bovenaan aangemaakt.
                }
            }
        }
        /*
        ...
        {
            // Kan ook direct in Evolve
            return behaviour.CellShouldLive(livingCell, neighbourCount);
        }
        */
